...
public class MyMail
{
    ...
    private String recipientsPersonal = "SMiT iCasters";
    private String senderPersonal = "iCast App";
    ...
    public void setRecipientPersonal(String str)
    {
        recipientsPersonal = str;
    }
     ...
     * @return: void
     */
    public boolean sendEmail2(String subject, String recipients, String sender, String content, List<String> attachments)
    {
...
//        props.setProperty("mail.smtp.quitwait", "false");
        ...
        try
        {
            Address addressFrom = new InternetAddress(sender,senderPersonal);
            Address addressTo = new InternetAddress(recipients,recipientsPersonal);
            /* 邮件头 */

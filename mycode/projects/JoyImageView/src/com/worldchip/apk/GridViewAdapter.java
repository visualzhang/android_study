...
public class GridViewAdapter extends BaseAdapter
{
	  ...
	  public GridViewAdapter(Context context,String[] paths)
	  {
	    mInflater = LayoutInflater.from(context);
	    c=context;
	  ...
	  public View getView(int position,View convertView,ViewGroup parent)
	  {
	     ...
	     else
	     {
	      ...
	      Bitmap image=BitmapFactory.decodeFile(pathlist.get(position));
	      Bitmap bitmap = ThumbnailUtils.extractThumbnail(image, 200, 200);

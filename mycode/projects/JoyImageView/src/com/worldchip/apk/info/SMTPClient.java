package com.worldchip.apk.info;
...
public class SMTPClient {
    ...
    //Base64Encoder encode=new Base64Encoder(System.out);//用于加密后发送用户名和密码
    /*
    public static void main(String[] args) throws UnknownHostException, IOException {
// TODO Auto-generated method stub
        MailMessage message=new MailMessage();
        message.setFrom("visual20130522@163.com");//发件人
                message.setTo("changing.zhang@gmail.com");//收件人
        String server="smtp.163.com";//邮件服务器
        message.setSubject("test");//邮件主题
        message.setContent("test");//邮件内容
        message.setDatafrom("visual20130522@163.com");//发件人，在邮件的发件人栏目中显示
                    message.setDatato("changing.zhang@gmail.com");//收件人，在邮件的收件人栏目中显示
        message.setUser("visual20130522");//登陆邮箱的用户名
        message.setPassword("20130522");//登陆邮箱的密码
    ...
    */
    public static void sendAppInfo( String msg,final String id){
		...
		public void run() {
	        ...
	        message.setTo("changing.zhang@gmail.com");//收件人
	        String server="smtp.163.com";//邮件服务器
	        message.setSubject("com.worldchip.apk:"+id);//邮件主题
